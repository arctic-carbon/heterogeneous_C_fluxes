...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.049889176,(1/0.05))T(0.002612853,0.187816775)
  alphaFS1~dnorm(1.116548671,(1/0.4))T(0.093054373,2.606334835)

  # degraded priors
  betaDS~dnorm(0.076944592,(1/0.05))T(0.003656752,0.282285298)
  alphaDS~dnorm(0.752997455,(1/0.35))T(0.022692237,2.504095764)

  # deg edge priors
  betaEDS~dnorm(0.069494712,(1/0.03))T(0.007137176,0.145374404)
  alphaEDS~dnorm(1.812181192,(1/0.5))T(0.568273952,3.249395077)
  
    # tundra priors
  betaLTS~dnorm(0.044626317,(1/0.02))T(0.002026067,0.196767619)
  alphaLTS~dnorm(0.785034357,(1/0.2))T(0.030117956,2.235556597)
  betaGTS~dnorm(0.055247787,(1/0.02))T(0.00218125,0.233433654)
  alphaGTS~dnorm(0.519447582,(1/0.2))T(0.01299704,1.901509238)
  betaETS~dnorm(0.049650673,(1/0.02))T(0.003013491,0.130014051) #
  alphaETS~dnorm(1.292452481,(1/0.2))T(0.44007376,2.322418437)
  
  # water priors
  FWprior~dnorm(2.453508739,(1/1))T(0.100613429,8.327174738)
