...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.073354356,(1/0.05))T(0.003133131,0.302015845)
  alphaFS1~dnorm(0.283306422,(1/0.4))T(0.006937433,1.234085818)
  
  # degraded priors
  betaDS~dnorm(0.112253863,(1/0.05))T(0.005383412,0.350619348)
  alphaDS~dnorm(1.024077389,(1/0.35))T(0.037224659,2.838897999)

  # deg edge priors
  betaEDS~dnorm(0.047379921,(1/0.03))T(0.002218602,0.205328095)
  alphaEDS~dnorm(1.065678171,(1/0.5))T(0.067534193,2.549067603)
  
    # tundra priors
  betaLTS~dnorm(0.086332653,(1/0.02))T(0.003619099,0.384240166)
  alphaLTS~dnorm(0.148339792,(1/0.2))T(0.002827463,0.92333655)
  betaGTS~dnorm(0.049486195,(1/0.02))T(0.002108054,0.218002984)
  alphaGTS~dnorm(0.933583978,(1/0.2))T(0.039920561,2.339235068)
  betaETS~dnorm(0.026539187,(1/0.02))T(0.001511666,0.081007846) #
  alphaETS~dnorm(2.050552731,(1/0.02))T(1.101184908,2.960495301) #
  
  # water priors
  FWprior~dnorm(1.655384964,(1/1))T(0.084382653,5.032241738)
