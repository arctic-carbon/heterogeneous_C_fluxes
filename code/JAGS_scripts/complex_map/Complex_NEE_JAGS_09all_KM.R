...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.027782911,(1/0.05))T(0.001276362,0.108578859)
  alphaFS1~dnorm(2.241251298,(1/0.4))T(1.067821613,3.327448719)

  # degraded priors
  betaDS~dnorm(0.073744492,(1/0.05))T(0.002701331,0.344842567)
  alphaDS~dnorm(0.646667172,(1/0.35))T(0.01815892,2.410284114)

  # deg edge priors
  betaEDS~dnorm(0.076799492,(1/0.03))T(0.003399153,0.28290095)
  alphaEDS~dnorm(1.14842058,(1/0.5))T(0.144498331,2.518877173)
  
    # tundra priors
  betaLTS~dnorm(0.110337646,(1/0.02))T(0.003926125,0.375146373)
  alphaLTS~dnorm(0.201584636,(1/0.2))T(0.007587125,0.930722159)
  betaGTS~dnorm(0.020627851,(1/0.02))T(0.000665382,0.162229518)
  alphaGTS~dnorm(1.214919708,(1/0.2))T(0.115681131,2.400713349)
  betaETS~dnorm(0.009574946,(1/0.02))T(0.000377913,0.047763928) #
  alphaETS~dnorm(2.142346037,(1/0.2))T(1.365931301,2.792721292)
  
  # water priors
  FWprior~dnorm(3.725171012,(1/1))T(0.752820623,6.855840794)
