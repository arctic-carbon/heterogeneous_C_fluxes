...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.075475475,(1/0.05))T(0.002989872,0.28691313)
  alphaFS1~dnorm(0.304607227,(1/0.4))T(0.008195766,1.267436306)
  
  # degraded priors
  betaDS~dnorm(0.113467962,(1/0.05))T(0.005679458,0.33298006)
  alphaDS~dnorm(1.049920186,(1/0.35))T(0.047317435,2.842523237)

  # deg edge priors
  betaEDS~dnorm(0.047548262,(1/0.03))T(0.002223335,0.176717301)
  alphaEDS~dnorm(1.276127891,(1/0.5))T(0.160624754,2.673632155)
  
    # tundra priors
  betaLTS~dnorm(0.078044767,(1/0.02))T(0.003202564,0.355124168)
  alphaLTS~dnorm(0.189235101,(1/0.2))T(0.003889017,1.011520134)
  betaGTS~dnorm(0.04279464,(1/0.02))T(0.001892201,0.189396161)
  alphaGTS~dnorm(1.062022701,(1/0.2))T(0.058026701,2.570438658)
  betaETS~dnorm(0.023366012,(1/0.02))T(0.000975396,0.08795403) #
  alphaETS~dnorm(1.872402481,(1/0.02))T(0.798432093,2.902152122) #
  
  # water priors
  FWprior~dnorm(1.586320198,(1/1))T(0.073391845,4.982856675)
