...
# priors for Reco come from Rd fit for 0620 data.
...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.059679197,(1/0.05))T(0.003049247,0.219576036)
  alphaFS1~dnorm(1.160618446,(1/0.4))T(0.069283623,2.769794617)

  # degraded priors
  betaDS~dnorm(0.081024981,(1/0.05))T(0.003915562,0.280555109)
  alphaDS~dnorm(0.738992392,(1/0.35))T(0.022065548,2.497675899)

  # deg edge priors
  betaEDS~dnorm(0.071301156,(1/0.03))T(0.005744982,0.160868964)
  alphaEDS~dnorm(1.683873992,(1/0.5))T(0.364516604,3.253821115)
  
    # tundra priors
  betaLTS~dnorm(0.049063971,(1/0.02))T(0.00201711,0.204180238)
  alphaLTS~dnorm(0.607946254,(1/0.2))T(0.019117431,2.005330877)
  betaGTS~dnorm(0.057433756,(1/0.02))T(0.002756677,0.21001617)
  alphaGTS~dnorm(0.824817312,(1/0.2))T(0.036168294,2.346097955)
  betaETS~dnorm(0.042559157,(1/0.02))T(0.002523877,0.114079816) #
  alphaETS~dnorm(1.366404214,(1/0.2))T(0.449903135,2.378537265)
  
  # water priors
  FWprior~dnorm(2.611704434,(1/1))T(0.123836437,8.858812175)
