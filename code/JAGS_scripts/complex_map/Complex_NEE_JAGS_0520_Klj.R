...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.079995002,(1/0.05))T(0.003164435,0.317830681)
  alphaFS1~dnorm(0.274829698,(1/0.4))T(0.006470264,1.307217752)

  
  # degraded priors
  betaDS~dnorm(0.112227284,(1/0.05))T(0.006045554,0.337467921)
  alphaDS~dnorm(1.026602019,(1/0.35))T(0.041534722,2.914933762)

  # deg edge priors
  betaEDS~dnorm(0.05143724,(1/0.03))T(0.00218451,0.214960772)
  alphaEDS~dnorm(1.177510771,(1/0.5))T(0.067544426,2.887328003)
  
    # tundra priors
  betaLTS~dnorm(0.081468839,(1/0.02))T(0.003045987,0.357812947)
  alphaLTS~dnorm(0.130867929,(1/0.2))T(0.002795693,0.818678094)
  betaGTS~dnorm(0.046605206,(1/0.02))T(0.002934714,0.158098331)
  alphaGTS~dnorm(1.85060769,(1/0.2))T(0.265085054,3.380934523)
  betaETS~dnorm(0.018317725,(1/0.02))T(0.00074378,0.0763553) #
  alphaETS~dnorm(1.578463699,(1/0.02))T(0.61072491,2.470831114) #
  
  # water priors
  FWprior~dnorm(2.333995967,(1/1))T(0.128159435,6.990827024)
