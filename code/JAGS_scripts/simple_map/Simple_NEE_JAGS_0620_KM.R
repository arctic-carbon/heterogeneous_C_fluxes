...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.060130427,(1/0.05))T(0.002916137,0.259326829)
  alphaFS1~dnorm(0.961397076,(1/0.2))T(-0.130539194,2.61774451)
  # degraded priors
  betaDS~dnorm(0.094622626,(1/0.05))T(0.004274684,0.316012658)
  alphaDS~dnorm(0.643398082,(1/0.2))T(-0.573624631,2.461156468)
  # tundra priors
  betaLTS~dnorm(0.048811207,(1/0.02))T(0.009857636,0.089877279)
  alphaLTS~dnorm(1.31557751,(1/0.2))T(0.859242692,1.90450781)
  
  # water priors
  FWprior~dnorm(2.244962773,(1/1))T(0.099626469,8.103698898)
