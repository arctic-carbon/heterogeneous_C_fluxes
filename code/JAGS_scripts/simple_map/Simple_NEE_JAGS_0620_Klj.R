...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.068329917,(1/0.05))T(0.003460289,0.263606589)
  alphaFS1~dnorm(0.885088233,(1/0.2))T(-0.247837763,2.611061508)
  # degraded priors
  betaDS~dnorm(0.123169557,(1/0.05))T(0.007761016,0.302329184)
  alphaDS~dnorm(1.06432616,(1/0.2))T(-0.278608928,2.902826611)
  # tundra priors
  betaLTS~dnorm(0.044801105,(1/0.02))T(0.006965213,0.087553568)
  alphaLTS~dnorm(1.326331786,(1/0.2))T(0.854227863,1.881557127)
  
  # water priors
  FWprior~dnorm(2.689058694,(1/1))T(0.109309762,9.705729604)
