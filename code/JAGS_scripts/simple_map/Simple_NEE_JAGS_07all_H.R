...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.094806916,(1/0.05))T(0.039641603,0.153165864)
  alphaFS1~dnorm(1.851874597,(1/0.2))T(0.739557104,3.349295467)
  # degraded priors
  betaDS~dnorm(0.113849543,(1/0.05))T(0.03777339,0.197431812)
  alphaDS~dnorm(1.99963062,(1/0.2))T(0.587692612,3.714193501)
  # tundra priors
  betaLTS~dnorm(0.037152993,(1/0.02))T(0.004647836,0.07439212) 
  alphaLTS~dnorm(1.502401107,(1/0.2))T(0.972439723,2.124697029)
  # water priors
  FWprior~dnorm(1.674047037,(1/1))T(0.069896891,6.537328937)
