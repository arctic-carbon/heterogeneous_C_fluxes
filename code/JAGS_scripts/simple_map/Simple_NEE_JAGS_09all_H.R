...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.022642311,(1/0.05))T(0.000817018,0.105824385)
  alphaFS1~dnorm(2.047724878,(1/0.2))T(0.977281811,3.008726242)
  # degraded priors
  betaDS~dnorm(0.101787497,(1/0.05))T(0.003216279,0.448152578)
  alphaDS~dnorm(0.182136348,(1/0.2))T(-0.737631019,2.168346931)
  # tundra priors
  betaLTS~dnorm(0.043867298,(1/0.02))T(0.023167731,0.062716026) 
  alphaLTS~dnorm(1.364916477,(1/0.2))T(1.164006633,1.571421925)

  # water priors
  FWprior~dnorm(1.697033936,(1/1))T(0.107316875,4.437128419)
