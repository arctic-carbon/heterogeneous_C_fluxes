...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.051986896,(1/0.05))T(0.002255032,0.198180873)
  alphaFS1~dnorm(0.976427349,(1/0.2))T(0.043155956,2.330656181)
  # degraded priors
  betaDS~dnorm(0.06796456,(1/0.05))T(0.00316897,0.252665114)
  alphaDS~dnorm(0.937643145,(1/0.2))T(-0.376366663,2.817927135)
  # tundra priors
  betaLTS~dnorm(0.053201473,(1/0.02))T(0.021909699,0.083967828) 
  alphaLTS~dnorm(1.704229943,(1/0.2))T(1.190134783,2.38782535)

  # water priors
  FWprior~dnorm(1.897407489,(1/1))T(0.087571516,6.478052033)
