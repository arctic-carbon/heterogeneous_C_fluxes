...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.054270378,(1/0.05))T(0.002241267,0.24633382)
  alphaFS1~dnorm(0.90226327,(1/0.2))T(-0.156692056,2.471932569)
  # degraded priors
  betaDS~dnorm(0.092041617,(1/0.05))T(0.004349108,0.299910016)
  alphaDS~dnorm(0.755923525,(1/0.2))T(-0.456051037,2.476919178)
  # tundra priors
  betaLTS~dnorm(0.049013617,(1/0.02))T(0.009836366,0.09137505)
  alphaLTS~dnorm(1.330915468,(1/0.2))T(0.85582325,1.928942518)
  
  # water priors
  FWprior~dnorm(2.137115259,(1/1))T(0.098697875,7.977359234)
