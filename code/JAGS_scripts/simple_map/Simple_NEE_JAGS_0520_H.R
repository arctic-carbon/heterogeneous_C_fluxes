...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.085341238,(1/0.05))T(0.003654597,0.318505793)
  alphaFS1~dnorm(0.119723145,(1/0.2))T(-0.591606192,1.054102932)
  # degraded priors
  betaDS~dnorm(0.149162067,(1/0.05))T(0.009795904,0.368678461)
  alphaDS~dnorm(1.120236715,(1/0.2))T(-0.079565341,2.906277857)
  # tundra priors
  betaLTS~dnorm(0.024095328,(1/0.02))T(0.001455208,0.063583227)
  alphaLTS~dnorm(1.33326825,(1/0.2))T(1.033406729,1.626638782)
  
  # water priors
  FWprior~dnorm(1.545801687,(1/1))T(0.074510002,5.032693914)
