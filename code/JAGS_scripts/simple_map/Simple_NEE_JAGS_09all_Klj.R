...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.062216687,(1/0.05))T(0.003801474,0.152995292)
  alphaFS1~dnorm(1.889224531,(1/0.2))T(0.781620031,3.197424385)
  # degraded priors
  betaDS~dnorm(0.096469312,(1/0.05))T(0.003877572,0.36768793)
  alphaDS~dnorm(0.713350601,(1/0.2))T(-0.529467581,2.643589381)
  # tundra priors
  betaLTS~dnorm(0.029337763,(1/0.02))T(0.0056706,0.052840162) 
  alphaLTS~dnorm(1.428436578,(1/0.2))T(1.220374909,1.631632585)

  # water priors
  FWprior~dnorm(2.398468008,(1/1))T(0.19952433,5.913317604)
