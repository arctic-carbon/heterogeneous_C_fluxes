...
model {
  ...
  # fen priors
  betaFS1~dnorm(0.081298671,(1/0.05))T(0.00537271,0.221816102)
  alphaFS1~dnorm(1.050834692,(1/0.2))T(0.096959866,2.530432628)
  # degraded priors
  betaDS~dnorm(0.083022809,(1/0.05))T(0.003411547,0.345001021)
  alphaDS~dnorm(0.42463718,(1/0.2))T(-0.757391779,2.541009995)
  # tundra priors
  betaLTS~dnorm(0.049989117,(1/0.02))T(0.017815128,0.080366292) 
  alphaLTS~dnorm(1.690334647,(1/0.2))T(1.199979561,2.375165209)

  # water priors
  FWprior~dnorm(3.669867021,(1/1))T(0.20014627,10.33698421)
